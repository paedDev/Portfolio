...
const Navbar = ({ }) => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-10 ${isMenuOpen ? 'bg-sky-950' : ''}`}>
      ...
      ${isMenuOpen
        ...
        <div className='bg-sky-950 backdrop:blur-sm '>
          <div className={`flex flex-col space-y-1 text-gray-400 text-sm w-full mx-auto $ pb-4 px-1 `}>
